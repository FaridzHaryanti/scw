...
<section class="ticket-feature">
    <div id="ticketCarousel" class="carousel slide" data-touch="false" data-ride="carousel" data-interval="" data-pause="hover">
        ...
        <!-- Controls -->
        <a class="carousel-control-prev" href="#ticketCarousel" role="button" data-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
        </a>
        <a class="carousel-control-next" href="#ticketCarousel" role="button" data-slide="next">
				...
				<div class="content-block">
					...
					<div class="description-two">
						<p>Indonesia merupakan negara dengan tingkat penyakit kronis yang cukup besar. Berdasarkan
							...
							kronis yaitu kanker 1.79%...</p>
					</div>
					<ul class="list-inline">
						<li class="list-inline-item">
							<a href="tentang.php" class="btn btn-transparent-md">Selengkapnya</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-12">
				<div class="section-title">
					<h3>Dapatkan Segera!</h3>
					<p>Kegiatan ini berbentuk seminar & workshop yang diselenggarakan secara online dan offline</p>
				</div>
			</div>
		</div>
			...
			<div class="col-lg-4 col-md-6">
				...
				<div class="pricing-item">
					...
					<div class="pricing-footer text-center">
						<a href="https://wocare.id/event/detail_acara.php?id=106" class="btn btn-main-md">Beli Tiket</a>
					</div>
				</div>
			</div>
			<div class="col-lg-4 col-md-6">
...
<section class="news-hr section mb-0">
	<div class="container">
		...
		<?php while ($row = mysqli_fetch_assoc($result_workshop)) { ?>
			<div class="col-lg-6">
				...
				<div class="block text-center">
					...
					<ul class="list-inline sponsors-list">
						...
						<li class="list-inline-item">
							<div class="image-block text-center">
								<a href="#">
									<img src="images/logo/sme.png" alt="sponsors-logo" class="img-fluid">
								</a>
							</div>
						</li>
					</ul>
